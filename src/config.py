...
def get_config():
    ...
    parser.add_argument("--config_path", type=str, default="./config/tusimple_resnet18.yaml",
                        help="Config file path")
    path_args, _ = parser.parse_known_args()
    config_path = os.path.join(current_dir, '../', path_args.config_path)
    default, helper, choices = parse_yaml(config_path)
    args = parse_cli_to_yaml(parser=parser, cfg=default,
                             helper=helper, choices=choices, cfg_path=config_path)
